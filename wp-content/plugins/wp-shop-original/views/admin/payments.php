	...
	<div id="poststuff">
		<div class="postbox">
					...
					<tr>
						<td>
							...
							<tr>
								...
								<td style="min-width:300px;"><input style="width:100%;" type="text" name="wpshop_payments_ek[resultUrl]" value="<?php  echo $this->ek['resultUrl'];?>"  readonly="readonly"/></td>
							</tr>
							<input type="hidden" name="wpshop_payments_ek[passfrase]" value="<?php  echo $this->ek['passfrase'];?>"/>
							</table>
						</td>
						<?php add_thickbox(); ?>
          ...
          <tr>
								...
								<td style="min-width:300px;"><input style="width:100%;" type="text" name="wpshop_payments_yandex_kassa[resultUrl]" value="<?php  echo $this->yandex_kassa['resultUrl'];?>"  readonly="readonly"/></td>
							</tr>
					<tr>
